...
for(r in regions){
  ...
  silva <- getDepths(silvaFileName)-1 #we have the root on these as a taxonomic level
  ...
  silva <- getDepths(silvaMock)-1 #we have the root on these as a taxonomic level
...
getDepthByLibrary <- function(region){
  ...
  depth.file <- paste(region, "/",  "mock.tax.compare", sep="")
