...
errorMinQualityScore <- function(folder){
  ...
  points(binned, type="l", col=clrs[folder], lwd=2)
}
...
fractionMinQualityScore <- function(folder){
  ...
  points(remaining, type="l", col=clrs[folder], lwd=2)
}
