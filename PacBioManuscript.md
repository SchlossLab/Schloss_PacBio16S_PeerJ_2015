...
sequences. These platforms have allowed reserachers to significantly improve
the design of their experiments. The tradeoff has been the decline in the number
of full-length reference sequneces that are deposited into databases. To
...
gene from a synthetic mock community and natural samples collecte from human
...
V1-V9 region from 2.16% to 0.32%. Unfortuantely, this error rate was still 
