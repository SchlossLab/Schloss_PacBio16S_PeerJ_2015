...
this approach is likely limited by its high sequencing error and low yield of
sequencing data relative to the other platforms.
...
only 250 bp. In the case of 454 Titanium, extending the length of the
...
the PCR products and sequenced at the University of Michigan DNA Sequencing Core
using the P4-C2 chemistry on a PacBio RS II SMRT DNA Sequencing System.
...
rate associated with sequencing the 16S rRNA gene. We observed a average 
